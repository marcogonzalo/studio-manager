...
title: How to streamline workflow in an interior design studio
date: 2026-02-10
excerpt: "Three operational habits that reduce friction between design, purchasing, and client handoff: freezing scope by phase, keeping a single source of truth for all numbers, and running a weekly project review."
slug: interior-studio-workflow
...
**When should you document the scope of each phase?**
Before the client approves the proposal. If the scope isn't in the document they sign, it doesn't exist.

**What happens when a client requests changes once purchasing has started?**
This is when the extras protocol kicks in: a supplemental quote, written approval, and a change record logged in the project history. Without that record, the extra becomes a gift.

**How many simultaneous projects does it take before a dedicated management tool becomes necessary?**
Most studios start feeling the friction at three or more projects in different phases. It's less about the number and more about complexity: one large project with many suppliers can demand the same structure as four smaller ones.
