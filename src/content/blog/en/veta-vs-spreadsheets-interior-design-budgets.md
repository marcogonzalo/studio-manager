...
1. Useful product data lives in the catalog and project lines, not a lone cell
2. You can see which supplier you used and on what terms
3. When pricing changes, you keep traceability in the project and catalog
...
**Can I recreate in Veta a project I only have in Excel?**
Yes. **Any project you've tracked in a spreadsheet can be replicated in Veta** with the same information—lines, products, amounts, dates—organized inside an app project. There is no automatic CSV or workbook import; you enter the data into Veta's structure, then run the job from one place instead of parallel sheets.

**Does the client need a Veta account?**
