  ...
  return (
    <div className="space-y-8">
      <div className="flex flex-col items-start justify-between gap-4 md:flex-row md:items-center">
        ...
        <Button
          asChild
          className="bg-primary hover:bg-primary/90 text-primary-foreground shadow-primary/20 shadow-lg transition-all hover:scale-105"
        >
          <Link href="/projects">
      ...
      <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-4">
        <Card className="to-secondary/20 dark:from-card dark:to-secondary/10 group border-none bg-gradient-to-br from-white shadow-md transition-all duration-300 hover:shadow-lg">
      ...
      <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-7">
              ...
              <div className="bg-secondary/10 border-border flex flex-col items-center justify-center space-y-4 rounded-xl border border-dashed py-10 text-center">
                ...
                <div className="space-y-1">
                  ...
                  <p className="text-muted-foreground mx-auto max-w-xs text-sm">
                    Crea un proyecto para empezar a gestionar clientes, espacios
                    y presupuestos.
                  </p>
                </div>
        ...
        <Card className="bg-primary/5 col-span-3 border-none shadow-md">
          <CardHeader>
