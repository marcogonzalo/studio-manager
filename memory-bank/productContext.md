...
**Vistas de planes** (rutas de un solo nivel): Tres landings comerciales, cada una orientada a un perfil y sus pains:

| Plan   | Ruta          | Perfil / contexto                                                                 | Pains principales                                                                 |
|--------|----------------|------------------------------------------------------------------------------------|------------------------------------------------------------------------------------|
| **Base**  | `/plan-base-primer-proyecto-interiorismo`   | Persona curiosa, que no se decide a pagar, o que empieza en solitario sin flujo de proyectos. | No pagar sin probar; empezar en interiorismo; aún no hay flujo constante de proyectos. |
| **Pro**   | `/plan-pro-independientes-diseno-interior` | Profesional con cartera de proyectos al año, varios a la vez o proyectos más grandes; necesita control del flujo de dinero. | Varios proyectos y se escapa el control; no saber si gana o pierde; profesionalizar la gestión del dinero. |
| **Studio**| `/plan-studio-empresas-arquitectura-diseno-interior` | Estudio consolidado, posiblemente con equipo; múltiples proyectos, ritmo continuo (cierra uno y empieza otro). | Ritmo que no para; equipo que necesita una sola fuente de verdad; presupuestos con su marca y soporte real. |
