...
--       budget_mode: none, support: none, costs_management: basic, multi_currency: basic
-- PRO: 5 active projects, unlimited clients/suppliers/products, 10 GB storage
--      budget_mode: basic (Veta branding), support: basic, costs_management: full, multi_currency: full
-- STUDIO: 50 active projects, unlimited, 100 GB storage
--         budget_mode: full (white label), support: full, costs_management: full, multi_currency: full
